          ...
          <div className="ModalWindow__container">
            <Container fluid className="ModalWindow__header p-0">
              <Row className="m-0 h-100">
                ...
                <Col xs={2} className="ModalWindow__close d-flex justify-content-end align-items-center">
                  <Icon.XCircleFill width={47} height={47} fill={`#3B3B3B`} onClick={() => closeButtonHandler()} />
                </Col>
              </Row>
            </Container>
            <Container fluid className="ModalWindow__body">
              ...
              {loader ? (
                ...
                <ButtonComponent onClick={() => sendButtonClick({ name, phoneNumber: userPhone })}>
                  {' '}
                  Отправить
                </ButtonComponent>
              )}
              <p>
                Оставляя заявку, вы соглашаетесь с <a href="./politic.pdf" target={`_blank`}>политикой конфиденциальности</a>
              </p>
            </Container>
          </div>
        </div>
