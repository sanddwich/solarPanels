            ...
            <Container>
                <div className="MainFooter__row1">
                    ...
                    <div className="MainFooter__navigation">
                        <div className="MainFooter__navigationEl hvr-underline-from-left"
                             onClick={() => scrollTo('Block2', 0)}>Типы систем
                        </div>
                        <div className="MainFooter__navigationEl hvr-underline-from-left"
                             onClick={() => scrollTo('Block4', 0)}>Этапы
                        </div>
                        <div className="MainFooter__navigationEl hvr-underline-from-left"
                             onClick={() => scrollTo('Block6', 0)}>Выполненые проекты
                        </div>
                        <div className="MainFooter__navigationEl hvr-underline-from-left"
                             onClick={() => scrollTo('Block7', 0)}>Отзывы
                        </div>
                        <div className="MainFooter__navigationEl hvr-underline-from-left"
                             onClick={() => scrollTo('Block8', 0)}>Контакты
                        </div>
                    </div>
                ...
                <div className="MainFooter__row2">
                    ...
                    <div className="MainFooter__copyright">Сайт разработали – <a
                        href="https://deedesign.ru/">DEEDESIGN</a></div>
